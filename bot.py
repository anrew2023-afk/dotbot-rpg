...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    user = get_user(user_id)
    if user is None:
        keyboard = [[InlineKeyboardButton("👦 Мужской", callback_data="gender_male"), InlineKeyboardButton("👧 Женский", callback_data="gender_female")]]
        await update.message.reply_text("👋 Добро пожаловать в DotBotRPG!\n\nДля начала выберите свой пол:", reply_markup=InlineKeyboardMarkup(keyboard))
    else:
